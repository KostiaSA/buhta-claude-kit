...
legacy-системой учёта. Покрывает **пользовательские формы** (движок dream), **печатные шаблоны
отчётов** (FastReport) и **генерацию проводок из документов**, плюс инструменты работы с БД MSSQL и
HTTP-сервером автоматизации `.exe`.
